    ...
    if (status !== 'loading' && status === 'authenticated') {
        ...
        return (
            <div className="mt-24 w-full flex flex-col items-center">
                <div className="flex flex-col items-center px-10 py-10 gap-5 rounded-md border-solid border-[1px] border-black border-opacity-10 shadow-sm shadow-[0_3px_6px_rgb(0,0,0,0.1)]">
                    <div className="relative w-[100px] h-[100px] rounded-full border-2 border-solid border-black">
